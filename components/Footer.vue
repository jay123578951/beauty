  ...
  <footer class="mx-4 mb-20 rounded-2xl bg-white dark:bg-gray-900 lg:mb-0">
    <div class="mx-auto w-full max-w-screen-xl p-4 md:py-8">
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        >
          <li>
            <a href="#" class="me-4 hover:underline md:me-6">推薦</a>
          </li>
          <li>
            <a href="#" class="me-4 hover:underline md:me-6">沙龍檢索</a>
          </li>
          <li>
            <a href="#" class="me-4 hover:underline md:me-6">收藏</a>
          </li>
          <li>
            <a href="#" class="hover:underline">預約履歷</a>
          </li>
        </ul>
      </div>
      <hr
