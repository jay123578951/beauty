  ...
  <NuxtLayout name="salon">
    ...
    <template #content>
      <section class="w-[24%] space-y-4 rounded-2xl border border-gray-300 p-4">
        <h2 class="border-b pb-4 text-lg">搜尋更多條件</h2>
        <fieldset class="border-b pb-4">
          <legend class="mb-2">價格</legend>
          <div class="relative mb-6">
            ...
            >
            <span
              class="absolute -bottom-6 start-1/3 -translate-x-1/2 text-sm text-gray-500 dark:text-gray-400 rtl:translate-x-1/2"
              >$500</span
            >
            <span
              class="absolute -bottom-6 start-2/3 -translate-x-1/2 text-sm text-gray-500 dark:text-gray-400 rtl:translate-x-1/2"
              >$1000</span
            >
            <span
      ...
      <section class="ml-4 h-screen w-[76%]">
        ...
        <ul class="space-y-4">
          <li class="flex space-x-4 rounded-2xl border border-gray-300 p-2">
            <div id="controls-carousel" class="relative" data-carousel="static">
              <!-- Carousel wrapper -->
              <div class="relative h-56 w-56 overflow-hidden rounded-2xl">
                <!-- Item 1 -->
            ...
            <div>
              <div class="flex items-center">
                <h3 class="mb-1 text-2xl font-medium">MADRAS</h3>
                <span
          ...
          <li class="flex space-x-4 rounded-2xl border border-gray-300 p-2">
            ...
            <div class="flex flex-col items-end justify-between p-2">
              ...
              <NuxtLink :to="`/salon/salon2`" target="_blank">
                <button
                  type="button"
                  class="whitespace-nowrap rounded-lg bg-blue-700 px-5 py-2.5 text-lg font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
